...
const checkToken = async (req, res, next)=> {
  try {
    ...
    console.log(error)
    sendResponse(req, res, 401, responseCode.ERROR, { key: 'tokenMissing' }, {})
  }
}
...
// Send Response
const  sendResponse = async (req, res, statuscode, response_code, { key='failed', component={} }, data={})=>{
  // console.log(key, component)
  const message = await getMessage(req.headers['accept-language'], key, component)
  // console.log(response_code)
    return res.status(statuscode).send({ code: response_code, message: message, data: data })
  }
...
module.exports = {sendResponse, checkToken, checkAPIKey}